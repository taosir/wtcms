...
class ArticleController extends HomebaseController {
    ...
    public function index() {
    	...
    	->where(array('b.id'=>array('neq',$article_id),"post_date"=>array("egt",$article_date),"a.status"=>1,'a.term_id'=>$term_id,'post_status'=>1))
    	->order("post_date asc")
    	->find();
    	...
    	->alias("a")
    	->join($join)->join($join2)
    	->where(array('b.id'=>array('neq',$article_id),"post_date"=>array("elt",$article_date),"a.status"=>1,'a.term_id'=>$term_id,'post_status'=>1))
